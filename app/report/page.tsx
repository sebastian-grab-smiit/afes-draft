...
import { ArrowLeft, Home, TextWrap, FormInput } from "lucide-react";
...
const PROOF_POINTS = [
  { icon: FormInput, text: "Platform coming soon" },
  { icon: TextWrap, text: "Leave us your feedback" },
];
              ...
              <div className="flex h-full max-w-[42rem] flex-col justify-center">
                <FadeIn>
                  <h1 className="text-balance text-[clamp(2rem,5vw,4rem)] font-bold leading-tight tracking-tight text-foreground">
                    Our Platform. <br className="hidden lg:block" />
                    <span className="text-muted-foreground">Coming soon.</span> <br className="hidden lg:block" />
                    <span className="text-primary">Always on track - with AFES.</span>
                  </h1>
                </FadeIn>

                <FadeIn delay={0.1}>
                  <p className="mt-6 max-w-xl text-[clamp(1rem,1.6vw,1.25rem)] leading-relaxed text-muted-foreground">
                    We are currently developing a digital platform for our claims services to enhance your experience with AFES.
                  </p>
                </FadeIn>
